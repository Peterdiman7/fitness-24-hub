<template>
  <div class="workout-detail-page" v-if="workout">
    ...
    <!-- Screen 1: Description & Overview -->
    <div v-if="currentStep === 1" class="screen overview-screen">
      <div class="container">
        <div class="workout-header">
          <button @click="goBack" class="back-link">← Back to Exercises</button>
    ...
    <!-- Screen 2: Step-by-Step Instructions -->
    <div v-if="currentStep === 2" class="screen instructions-screen">
      <div class="container">
        <div class="instructions-header">
          <button @click="currentStep = 1" class="back-btn">← Back to Overview</button>
